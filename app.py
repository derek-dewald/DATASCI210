...
def main():
    ...
    st.title('WETH/USDC Liquidity Pool Arbitrage Prediction')

      #Setting Application description
    st.markdown("""
     :dart:  This Streamlit app is made to predict instances where arbitrage could be possible between two pools consisting of WETH and USDC coins. 
    The application also contains a knowledge base to educate users on cryptocurrency, links to our datasets and data processing and machine learning strategies.
    """)
    ...
    "Navigate to", ("Arbitrage Prediction", "Data Generation Strategy", "Knowledge Base"))
    st.sidebar.info('This app is created to predict Customer Churn')
    #st.sidebar.image(image)

    if add_selectbox == "Arbitrage Prediction":
    ...
    elif add_selectbox == "Data Generation Strategy":
        st.subheader("Data Generation Strategy")
